...
//	public static final GameRun GAME_RUN = new GameRun();
...
//						System.err.println(
//								"****** " + GameLogic.getInstance().getCurrentPlayer().getName() + " Win ******");
//						System.err.println("Score : " + GameLogic.getInstance().getCurrentPlayer().getScore());
//						break;
//					}
